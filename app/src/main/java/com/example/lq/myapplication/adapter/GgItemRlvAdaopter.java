...
public class GgItemRlvAdaopter extends RecyclerView.Adapter {
    private static final String TAG = "jj";
    private final Context mContext;
    public final ArrayList<GgItemBean.DatasBean> mBeans;


    public GgItemRlvAdaopter(Context context, ArrayList<GgItemBean.DatasBean> beans) {
...
//                        DbUtils.getDbUtils().delete(dbBean);
    ...
    public void addData(GgItemBean knowBean) {
        mBeans.addAll(knowBean.getDatas());
        notifyDataSetChanged();
    }

    public void addSecond(List<GgItemBean.DatasBean> datas) {
        mBeans.addAll(datas);
        notifyDataSetChanged();
    }
